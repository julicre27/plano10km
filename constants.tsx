    ...
    content: (
       <div>
        ...
        <div className="bg-rose-50 border-l-4 border-rose-400 p-4 mb-6">
            <h3 className="font-semibold text-rose-800">PROGRAMA DE TREINO BASEADO EM PERCEPÇÃO DE ESFORÇO</h3>
        </div>
        <p className="text-gray-700 mb-4">
          A Escala de Percepção de Esforço é uma ferramenta simples e muito útil para corredores, especialmente para iniciantes usarem como um guia do nível de esforço que devem manter durante a corrida, sem precisar de equipamentos como frequencímetros.
        </p>
        <p className="text-gray-700 mb-4">
          Ela vai de 0 a 10, onde você auto-avalia, com base na sua sensação, percepção... o quão intenso está o treino, ou cada parte dele. Use essa escala durante todos os seus treinos.
        </p>
        <p className="text-gray-700 mb-4">
          Aqui está uma explicação prática de como usar:
        </p>
        <div className="bg-gray-100 p-4 rounded-lg space-y-2">
            <p><strong>2 a 4 (Leve):</strong> A corrida é mais ritmada, mas você ainda consegue conversar tranquilamente. Esse é o ritmo ideal para aquecimentos e treinos leves.</p>
            <p><strong>5 a 7 (Moderado):</strong> Você sente o coração e a respiração acelerando, mas ainda consegue falar algumas frases curtas.</p>
